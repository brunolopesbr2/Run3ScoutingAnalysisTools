...
static constexpr auto s_tag = "[HLTScoutingRepackProducer]";

TEST_CASE("Standard checks of HLTScoutingRepackProducer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("HLTScoutingRepackProducer"
