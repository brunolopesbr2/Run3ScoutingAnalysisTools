...
private: 
    ...
    int findCompatibleScoutingTrack(edm::Handle<Run3ScoutingParticleCollection> const& scoutingParticleCollection, Run3ScoutingTrack const& scoutingTrack);
...
void HLTScoutingUnpackProducer::produce(edm::Event& iEvent, edm::EventSetup const& iSetup) {
    ...
    edm::Handle<Run3ScoutingParticleCollection> scoutingParticle_collection_handle = iEvent.getHandle(scoutingParticle_collection_token_);
...
void HLTScoutingUnpackProducer::buildHitPattern(Run3ScoutingParticle const& scoutingPFCandidate, Run3ScoutingTrack const& scoutingTrack, reco::Track & recoTrack) {
    ...
    if((number_of_pixel_layers_with_measurement==number_of_tracker_layers_with_measurement) && (number_of_strip_hits>0)){
