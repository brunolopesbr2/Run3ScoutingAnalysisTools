...
process = cms.Process("L1Unpacker")
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring( "file:testDataFile.root" )
)
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('L1unpacked.root'),
)

process.p = cms.Path(process.hltGtStage2Digis +  
